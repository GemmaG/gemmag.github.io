---
layout: post
title:  ICFP 2016 talks by OCaml Labs and other interesting related ones
date:   2016-10-18 19:14:15 +0100
categories: ocamllabs icfp conference ocaml
---
...
![IOCaml
Notepad](2048 IOCaml notepad.png "fig:IOCaml Notepad"){width="200"}
![Mindy and Olivier at the OCaml
Tutorial](Olivier OCaml Tutorial.jpg "fig:Mindy and Olivier at the OCaml Tutorial"){width="200"}

Mindy ran this year's OCaml Tutorial, which started with a gentle
...
in a browser. We use [IOCaml
notepad](https://github.com/andrewray/iocaml) (an OCaml kernel for the
IPython notebook) written by Andy Wray to provide the resources needed,
...
[Talk
summary](https://github.com/ocamllabs/icfp2016-blog/blob/master/OCaml/invited-talk.md)
...
[Talk
summary](http://icfp2016.mirage.io/OCaml/the-state-of-the-ocaml-platfor.md)
|
...
[Talk
Summary](http://icfp2016.mirage.io/OCaml/learn-ocaml-an-online-learnin.md)
|
...
[Talk
Summary](http://icfp2016.mirage.io/OCaml/lockfree-programming-for-the-.md)
...
[Talk
Summary](http://icfp2016.mirage.io/OCaml/conex--establishing-trust-in.md)
|
...
![Enguerrand presenting
LibTLS](Engil Libtls.jpg "Enguerrand presenting LibTLS"){width="200"}
...
| [Abstract](http://din.osau.re/mrmime.pdf) ![Romain presenting Mr
Mime](Romain Mr Mime.jpg "fig:Romain presenting Mr Mime"){width="200"}
